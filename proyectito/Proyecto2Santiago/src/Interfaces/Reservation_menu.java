...
public class Reservation_menu extends javax.swing.JFrame {
     ...
     */
    public Reservation_menu(HashTable_Clients h, BinarySearchTree_Reservations ar, BDD_Rooms ah) {
        initComponents();
        this.bdd_clients = h;
    ...
    private void initComponents() {
        ...
        jPanel1.add(cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 220, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 190, 120, 40));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            this.jTextArea1.setText(bdd_reservations.searchReservation(Integer.parseInt(this.cedula.getText().replace(".", ""))).toString());
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reservation_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reservation_menu(bdd_clients, bdd_reservations, bdd_rooms).setVisible(true);
            }
        });
    }
