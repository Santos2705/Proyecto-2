...
public class Checkout__menu extends javax.swing.JFrame {
    public Hotel_Administration admin;
    ...
    /**
     * Creates new form Checkout__menu
     */
    public Checkout__menu(HashTable_Clients h, BinarySearchTree_Reservations ar, BDD_Rooms ah) {
        initComponents();
        this.bdd_clients = h;
        this.bdd_reservations = ar;
        this.bdd_rooms = ah;
        admin = new Hotel_Administration(ar, h, ah);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, 150, -1));
        ...
        jPanel1.add(nroHab, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 220, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 460, 760, 130));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 330, 140, 40));
        ...
        last_name.setFont(new java.awt.Font("Amazon Ember Display", 0, 14)); // NOI18N
        last_name.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 153)));
        jPanel1.add(last_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 260, 220, 30));

        name.setFont(new java.awt.Font("Amazon Ember Display", 0, 14)); // NOI18N
        name.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 153)));
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 220, 30));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 220, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            this.jTextArea1.setText(admin.Check_out(this.name.getText(), this.last_name.getText(), Integer.parseInt(this.nroHab.getText().replace(".", ""))));
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Checkout__menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Checkout__menu(bdd_clients, bdd_reservations, bdd_rooms).setVisible(true);
            }
        });
    }
