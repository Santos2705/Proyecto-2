...
public class CheckIn_menu extends javax.swing.JFrame {
     ...
     */
    public CheckIn_menu(HashTable_Clients h, BinarySearchTree_Reservations ar, BDD_Rooms ah) {
        initComponents();
        this.bdd_clients = h;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 30, 150, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, 140, 40));
        ...
        jLabel3.setText("Cédula del huesped:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            this.jTextArea1.setText(admin.Check_in(Integer.parseInt(this.nroHab.getText().replace(".", ""))));
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckIn_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckIn_menu(bdd_clients, bdd_reservations, bdd_rooms).setVisible(true);
            }
        });
    }
